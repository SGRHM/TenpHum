...
async function handleDelete(id){
	...
	if(window.confirm("Realente deseja excluir este Usuario?")){
		...
		var result = await api.delete('/sensor/delete/'+id)
							      ...
							      <Table className={classes.table} size="small" aria-label="a dense table">
							        <TableHead>
							          <TableRow>
							            ...
							            <TableCell align="center">Area de Producao</TableCell>
							            <TableCell align="center">Tipo de Sensor</TableCell>
							            <TableCell align="center">Localizacao</TableCell>
							        ...
							        <TableBody>
							            ...
							            <TableRow key={row._id}>
							              ...
							              <TableCell align="center">{row.areaProducao}</TableCell>
							              <TableCell align="center">{row.tipoSensor===1 ?<Chip label="Humidade" color="primary" /> : <Chip label="Temperatura" color="secondary" /> }</TableCell>
                            <TableCell align="center">{row.localizacao}</TableCell>
							              <TableCell align="right">

							              	<ButtonGroup aria-label="outlined secondary button group">
											  <Button color="primary" href={'/admin/sensores/editar/'+row._id} >Editar</Button>
